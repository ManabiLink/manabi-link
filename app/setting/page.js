...
export default function Page() {
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <Link
        href="/"
        className="inline-block mb-4 px-4 py-2 text-white bg-pink-500 rounded-lg hover:bg-pink-600 transition"
      >
        ← ホームに戻る
      </Link>
      ...
      {page === "password" && (
        <div className="bg-white p-6 rounded shadow">
          ...
          <div className="mb-3">
            <label className="block mb-1">新規パスワード</label>
            <input
              type="password"
              value={newPassword}
          ...
          <div className="mb-3">
            <label className="block mb-1">新規パスワード（確認）</label>
            <input
              type="password"
      ...
      {page === "email" && (
        <div className="bg-white p-6 rounded shadow">
          ...
          <div className="mb-3">
            <label className="block mb-1">新規メールアドレス</label>
            <input
              type="email"
              value={newEmail}
